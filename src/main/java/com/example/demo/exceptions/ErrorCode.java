...
public enum ErrorCode {
    ...
    INVALID_CONVERSATION(1013, "Sender and receiver cannot be the same", HttpStatus.BAD_REQUEST),
    ...
    USER_NOT_FOUND(9993, "Don't found user!", HttpStatus.BAD_REQUEST),
    NO_UPLOAD_FILE(9993, "Don't upload file!", HttpStatus.BAD_REQUEST),
    NO_FILE(9993, "No file!", HttpStatus.BAD_REQUEST),
    CART_NOT_FOUND(9993, "Cart not found!", HttpStatus.BAD_REQUEST),
    CATALOG_NOT_FOUND(9993, "Catalog not found!", HttpStatus.BAD_REQUEST),
    CATEGORY_NOT_FOUND(9993, "Category not found!", HttpStatus.BAD_REQUEST),
    DETAIL_CART_NOT_FOUND(9993, "DetailCart not found!", HttpStatus.BAD_REQUEST),
    DETAIL_ORDER_NOT_FOUND(9993, "DetailOrder not found!", HttpStatus.BAD_REQUEST),
    IMAGE_NOT_FOUND(9993, "Image not found!", HttpStatus.BAD_REQUEST),
    ORDER_NOT_FOUND(9993, "Order not found!", HttpStatus.BAD_REQUEST),
    PAYMENT_NOT_FOUND(9993, "Payment not found!", HttpStatus.BAD_REQUEST),
    PRODUCT_NOT_FOUND(9993, "Product not found!", HttpStatus.BAD_REQUEST),
    RATING_NOT_FOUND(9993, "Rating not found!", HttpStatus.BAD_REQUEST),
